    ...
    while True:
        ...
        if data.get('status') == '1':
            ...
            if int(SafeGasPrice) < 30 :
                ToSend = 1
                msg = 'SafeGasPrice={},ProposeGasPrice={},FastGasPrice={}'.format(SafeGasPrice,ProposeGasPrice,FastGasPrice)
        ...
        if ToSend:
            ...
            gather_logger.info("send msg:{}".format(msg))
            # 用于构建邮件头
